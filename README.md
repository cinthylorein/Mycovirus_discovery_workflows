...
7. Create summary table and visualization
   - Outputs:
     - A CSV summary table (e.g. summary_table.csv) containing one row per contig/sample pair with columns such as:
   ...
   - Example: Summary plot generated by the pipeline: ![Percent identity by sample](images/pident_by_sample.png)
---
