...
RAW_DIR="/workspace/hraczj/Virus_discovery_workflows/MVoPvirome/MVoP_pipeline/raw_reads"
#Optional: cetral output folder for FastQC reports 
FASTQC_OUT="/workspace/hraczj/Virus_discovery_workflows/MVoPvirome/MVoP_pipeline/fastqc"

files=($(ls /workspace/hraczj/Virus_discovery_workflows/MVoPvirome/MVoP_pipeline/raw_reads/*.fastq))
threads=2
